  ...
  return (
    <Card className='h-full w-96'>
      ...
      <div className='flex flex-row place-content-center justify-between'>
        ...
        <Button className='bg-red-600 hover:bg-red-800' type='button' onClick={() => removeTrip({id: trip._id})}> <Cross2Icon/> </Button>
        </div>
      </div>
    </Card>
  );
      ...
      <div className="flex flex-col space-y-10 place-items-center">
        <div className='flex flex-col place-items-center'>
          ...
          <div className='place-self-center my-20'>
            <Button type="button" onClick={() => router.push("/home/location")}>Plan A New Trip</Button>
          </div>
        </div>
